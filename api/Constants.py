...
class Constants:
    movies_json_file = os.path.realpath(os.path.join(os.getcwd(), "eel_module/web/movies.json"))
    torrents_json_file = os.path.realpath(os.path.join(os.getcwd(), "eel_module/web/torrents.json"))
    api_domain = "https://api.apidomain.info/list?quality=720p,1080p,3d&page={0}"
    movieKeys = ["title", "genres", "release_date", "rating", "imdb_link", "popcornTime", "iSubsMovies"]
